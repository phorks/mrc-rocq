...
Section semantics.
  ...
  | PEval_True : ∀ pdef,
      ...
      ∀ Hsig : args_match_sig vargs (pdef_sig V pdef),
  ...
  | SFEval_False : sfeval σ AT_True false
  | SFEval_Eq_True : ∀ t1 t2 v1 v2,
      teval σ t1 v1 →
      teval σ t2 v2 →
      v1 = v2 →
  ...
  Proof with auto.
    ...
    - inversion H; subst; (apply Is_true_andb; split; eapply teval_wf; [apply H2 | apply H3]).
